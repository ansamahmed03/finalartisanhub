...
<div class="card-header">
    ...
    <div class="card-header">
    <h3 class="card-title">Deleted customer</h3>
                  ...
                  @foreach($customers as $customer)
                    <tr>
                      ...
                      <td>
                             ...
                             <a href="{{ route('customers_force' , $customer->id ) }}" class="btn btn-sm" style="color: #c0392b;" title="force Delete">
...
@section('scripts')
        ...
        axios.get('/cms/admin/customers_restore/' + id)
    ...
    function performForceDelete(id, reference) {
        axios.get('/cms/admin/customers_force/' + id)
            .then(function (response) {
                toastr.success(response.data.title);
    ...
    function confirmForceAll() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                axios.get('/cms/admin/customers_force_all')
                    .then(function (response) {
                        toastr.success(response.data.title);
                        location.reload();
                    })
